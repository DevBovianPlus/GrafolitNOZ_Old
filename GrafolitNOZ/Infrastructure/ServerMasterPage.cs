...
using GrafolitNOZ.Helpers.DataProviders;
using System;
...
namespace GrafolitNOZ.Infrastructure
{
    public class ServerMasterPage : System.Web.UI.Page
    {
        ...
        protected OptimalStockOrderDataProvider GetOptimalStockOrderDataProvider()
        {
            OptimalStockOrderDataProvider provider = null;

            if (provider == null)
                return new OptimalStockOrderDataProvider();
